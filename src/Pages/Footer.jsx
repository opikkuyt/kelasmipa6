					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://instagram.com/opikqt?igshid=YTQwZjQ0NmI0OA==" class="hover:underline">
										OPIKQT
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://instagram.com/classix.smadi?igshid=MzRlODBiNWFlZA==" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://www.tiktok.com/@classixdump?_t=8ghZ6wZKgno&_r=1" class="hover:underline">
										TikTok
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XII MIPA 6 | Di Kelola Oleh Siswa MIPA 6
						</p>
					</div>
				</div>
			</div>
