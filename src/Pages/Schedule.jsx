...
const Schedule = () => {
  ...
  if (currentWeek === 1 || currentWeek === 3) {
    piketGroup = [
      ["Asri Nafisah", "Cindy Chandra", "Santi Agustiani", "Fusfita", "Vindi Alpina", "Melina", "Sandika"],
      ["Dian Maryana", "Dede Mirna", "Demike Wadhu", "Intan Nurqalbi", "M Alif Topan", "Kiki Supriadi", "Rena Mariana"],
      ["Putri Eka", "Zahra Alfiani", "Andini Aprialiani", "Amanda Salwa", "Vaira Viky", "Tia Yuliana", "M Nazril Ilham"],
      ["Nadin Auia", "Agis Andini", "Dwinanda", "Farid Rizki", "Taufik Kurrohman", "Salsabila", "Susi Susilawati"],
      ["Liliana Putri", "Siti Oktaviani", "Julita", "Muflih", "Ahmad Alvin", "Eva Rahma", "Agustian", "Indah Nurmala"],
    ];
